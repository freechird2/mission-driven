...
export const buttonVariants = cva(
  'flex items-center justify-center font-semibold cursor-pointer disabled:cursor-not-allowed',
  {
    variants: {
      ...
      size: {
        small: 'rounded-sm w-[65px] h-[38px] text-16 leading-[1.4]',
        medium: 'rounded-md w-[86px] h-[48px] text-18 leading-[1.3]',
        large: 'rounded-lg w-[92px] h-[58px] text-20 leading-[1.3]',
      },
      isActive: {
        true: '',
        false: '',
